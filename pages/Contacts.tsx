  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-2xl text-center">
      ...
      <p className="text-lg text-slate-600 mb-10">
        У вас есть вопросы по маршруту или вы хотите забронировать
        индивидуальный тур? Напишите мне в мессенджеры — я отвечаю быстро.
      </p>
      ...
      <div className="grid gap-4 max-w-md mx-auto">
        ...
        <div className="mt-8 pt-8 border-t border-slate-100">
          ...
          <a
            href={branding.contact.phone.href}
            className="text-2xl font-bold text-slate-900 hover:text-teal-600"
          >
            {branding.contact.phone.display}
          </a>
          <p className="text-sm text-slate-400 mt-2">
            {branding.contact.phone.availability}
          </p>
        </div>
      </div>
    </div>
