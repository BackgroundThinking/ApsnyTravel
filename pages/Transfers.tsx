...
export function Transfers() {
  usePageMeta({
    title: 'VIP Трансфер',
    description:
      'Комфортный трансфер из аэропорта Сочи во все направления: Красная Поляна, Центр Сочи, Абхазия. Фиксированные тарифы.',
    path: '/transfers',
  });
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-slate-900 mb-6">
          VIP-Трансфер из Аэропорта Сочи
        </h1>
        <p className="text-xl text-slate-600 mb-8">
          Предоставляем услуги комфортного трансфера из Международного аэропорта
          Сочи имени В. И. Севастьянова во все направления. Встретим вас в любой
          точке и доставим на самом высоком уровне — вам останется только
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100">
            ...
            <div className="mt-8 p-4 bg-slate-50 rounded-lg">
              ...
              <ul className="text-sm text-slate-600 space-y-2">
                <li>
                  • Почасовая оплата: <strong>2 000 руб./час</strong>
                </li>
                <li>
                  • Бизнес-день (до 10 часов): <strong>15 000 руб.</strong>
                </li>
                <li>
                  • Подача автомобиля в отдалённые районы — стоимость договорная
                </li>
                <li>
                  • Свыше 10 часов — <strong>1 000 руб./час</strong>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-slate-900 text-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-slate-300 mb-6">
                Свяжитесь с нами, чтобы забронировать автомобиль к вашему
                прилету.
              </p>
