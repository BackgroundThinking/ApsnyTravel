...
*   **AI:** Proposes a clear set of steps in a `markdown` list.
    *   *Example:* "1. Update `zod` to v3.22. 2. Fix lint errors in `App.tsx`. 3. Update `README.md` version."
...
*   **Dependency Audit:** Check for major updates to React, Vite, or Tailwind. *Note: Prioritize stability over newness.*
...
5.  **Validation Instructions:** Always end a turn with: *"Please run `npm run lint && npm run build` to verify."*
