...
export const REVIEWS: Review[] = [
  {
    ...
    date: '',
    comment:
      'Заказывали двухдневный индивидуальный трансфер с 10-часовыми обзорными экскурсиями по всей Абхазии. Побывали в горах, на диких пляжах, традиционных локациях. Увезли с собой уйму новых впечатлений! Спасибо Александру за компетентность и профессионализм!',
  },
  {
    id: 'r2',
    tourId: 'general',
    ...
    date: '',
    comment:
      'Александр профессионал своего дела. Все прошло качественно, безопасно и спокойно. Рекомендую!',
  },
  {
    id: 'r3',
    tourId: 'general',
    ...
    date: '',
    comment:
      'Маршрут экскурсий Александр составляет в соответствии с вашими интересами, учитывает дополнительные пожелания. А какие локации! Фото супер! Александр умеет видеть красоту и запечатлеть самые чудесные моменты. Обязательно вернёмся!',
  },
  {
    id: 'r4',
    tourId: 'general',
    ...
    date: '',
    comment:
      'Очень понравились индивидуальные туры по Абхазии. Даже не догадывались, сколько есть мест, куда вас не довезут групповые экскурсии, а Александр как раз покажет самое интересное. Плюс отлично фотографирует. Рекомендую однозначно!',
  },
  {
    id: 'r5',
    tourId: 'general',
    ...
    date: '',
    comment:
      'Александр знает нетривиальные места, делает очень крутые фото (у него прям талант). Автомобиль на уровне, всё как планировалось. Рекомендую!',
  },
  {
    id: 'r6',
    tourId: 'general',
    author: 'Производство электрокарнизов и штор',
    rating: 5,
    date: '',
    comment:
      'Супергид по Абхазии. Интересные локации, необычные места. Чистый автомобиль. Лёгкая подача информации. Экскурсией остались очень довольны.',
  },
  {
    id: 'r7',
    tourId: 'general',
    ...
    date: '',
    comment:
      'Прекрасно съездили, всё было на высшем уровне. Александр очень хорошо водит, показывает такие места, которые с автобуса не увидишь. Спасибо большое за приятную усталость от удовольствия.',
  },
];
...
export const TOURS: Tour[] = [
  // ABKHAZIA
  {
    ...
    short_desc:
      'Авторский маршрут: Гагра, Пицунда, озеро Рица, Новый Афон и дикие пляжи.',
    description_md: `
      ## Чего ожидать
  ...
  // SOCHI & COAST
  {
    ...
    short_desc:
      'Обзорная экскурсия: от исторического центра Сочи до футуристического Сириуса.',
    description_md: `
      ## Чего ожидать
  ...
  // KRASNAYA POLYANA
  {
    ...
    short_desc:
      'Три курорта: Роза Хутор, Газпром, Красная Поляна. Горы, канатки и казино.',
    description_md: `
      ## Чего ожидать
  ...
  // PHOTO TOURS
  {
    ...
    short_desc:
      'Peugeot 308 CC, ветер в волосах и профессиональные фото на ваш телефон.',
    description_md: `
      ## Чего ожидать
  ...
  // TRANSFERS
  {
    ...
    short_desc:
      'Встреча с табличкой, помощь с багажом, Mercedes E-Class или V-Class.',
    description_md: `
      ## Комфорт и статус
  ...
  },
  {
    ...
    short_desc:
      'Аренда авто с водителем на день. Для деловых встреч и мероприятий.',
    description_md: `
      ## Ваш личный водитель
