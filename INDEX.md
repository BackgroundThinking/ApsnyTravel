...
- **[CONTRIBUTING.md](./CONTRIBUTING.md)**: (If present) Guidelines for Git workflow, branching, and pull requests. _Note: If missing, follow standard GitHub Flow._

---

_This index is maintained by @Jules. Last updated: February 2025._
